                ...
                <div class="col-md-7 py-5 pr-md-5">
                    ...
                    <div class="owl-carousel testimonial-carousel position-relative pb-5 mb-md-5">
                        <div class="d-flex flex-column">
                            ...
                            <?= Html::img("@web/img/testimonial-1.jpg", ['alt' => 'testimonial', 'style' => 'width: 60px; height: 60px;', 'class' => "img-fluid rounded-circle"])?>
                                <div class="ml-3">
                                    <h5>Квон Джун</h5>
                                    <i>Художник</i>
                                </div>
                            </div>
                            <p>Достойно сделали ремонт в нашем доме. Я доволен их робой. Фирму не просто так выбирал. Они давно работают в данной сфере. Много про них слышал. На самом деле много реальных отзывов от знакомых. Поэтому осознано шел к ним.
                            Люди здесь работают ответственные. Качество работы очень приличное. Рабочих много, каждый занят своим направлением. Ну, и вобще, этапность соблюдена.</p>
                        </div>
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-3">
                            <?= Html::img("@web/img/testimonial-2.jpg", ['alt' => 'testimonial', 'style' => 'width: 60px; height: 60px;', 'class' => "img-fluid rounded-circle"])?>
                                <div class="ml-3">
                                    <h5>Ханбин Чои</h5>
                                    <i>Архитектор</i>
                                </div>
                            </div>
                            <p class="m-0">Если вы все еще задумываетесь над тем, к кому обратиться за помощью в правильной планировке дизайна и в целом в проведении ремонта, то советую обратить внимание на эту строительную компанию. 
                            Мне уже почти закончили обустраивать комнату в прихожей. Я очень рад, что поручил это нелегкое задание именно специалистам.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
